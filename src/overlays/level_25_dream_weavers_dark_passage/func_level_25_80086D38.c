/* func_level_25_80086D38 (0x80086D38, level_25_dream_weavers_dark_passage
 ...
 *
 * Arm 0x1C is decoded here (the same orbiting mote as level_26, with its own
 * stack vector); arm 0x15 writes `unk10 = 0` LAST in this variant, not before
 * `seed`.
...
void func_level_25_80086D38(int count, int type, int *pos, int arg3) {
  int v0[3];
  int v1[3];
  int vc[3];
  int v2[3];
