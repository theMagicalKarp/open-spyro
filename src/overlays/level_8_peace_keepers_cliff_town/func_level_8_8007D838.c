/* func_level_8_8007D838 (0x8007D838, level_8_peace_keepers_cliff_town overlay, 2568 bytes).
 *
...
void func_level_8_8007D838(void) {
  int titlePos[3];
  int titleColor[3];
  char title[32];
  int pagePos[3];
...
static const char g_szGoTo[12] = {'G', 'O', ' ', 'T', 'O', ' ',
                                  '%', 's', '\0', '*', '*', '*'};
