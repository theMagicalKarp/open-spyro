/* func_level_26_80084620 (0x80084620, level_26_dream_weavers_lofty_castle
 * overlay, 0xA80 bytes).
 *
...
extern int func_80016AB4(int y, int x, int mode);
...
Actor *func_level_26_80084620(int type, Actor *parent) {
  Actor *rec;
  int owner;
