/* func_level_34_80085230 (0x80085230, level_34_gnastys_world_gnastys_loot
 * overlay, 0x1034 bytes).
 *
...
void func_level_34_80085230(int count, int type, int *pos, int arg3) {
  int v0[3];
  int v1[3];
  int v2[3];
  int v3[3];
