/* func_level_32_80084EAC (0x80084EAC, level_32_gnastys_world_twilight_harbor
 ...
 * This variant's classes: 0x0, 0x1, 0x2, 0x6, 0x9, 0xA, 0xC, 0xD, 0x15, 0x18, 0x21, 0x42, 0x46, 0x47, 0x4C, 0x4D, 0x4E, 0x4F, 0x50.
 *
...
void func_level_32_80084EAC(int count, int type, int *pos, int arg3) {
  int v0[3];
  int v1[3];
  int v2[3];
  int v3[3];
