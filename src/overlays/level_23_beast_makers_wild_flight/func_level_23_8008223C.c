 ...
 *
 * Wild Flight shares the flight arm set with levels 5/11/17/29; the whole set
 * is word-identical here, including the 0x167..0x169 scatter burst decoded on
 * level_29.
 */
...
/* NOTE: the function body below is decomp-permuter output, spliced in
   ...
   with `git show HEAD:src/overlays/level_23_beast_makers_wild_flight/func_level_23_8008223C.c.wip`; this body came from
   build/permuter/nonmatchings/func_level_23_8008223C/output-325-1/source.c. */
Actor *func_level_23_8008223C(int type, Actor *parent)
{
  Actor *rec;
  int owner;
  rec = func_800524C4();
  ...
  switch (type)
  {
    ...
    case 0x177 ... 0x182:
    {
      ...
      dx = (signed char) parent->unk44;
      dy = (signed char) parent->unk45;
 do { dz = (signed char) parent->unk46; rec->unk44 = dx; rec->unk45 = dy; } while (0);
      rec->unk46 = dz;
      func_800526A8(rec);
      rec->unk4B = 0xBF;
      rec->unk4C = parent->unk4C;
