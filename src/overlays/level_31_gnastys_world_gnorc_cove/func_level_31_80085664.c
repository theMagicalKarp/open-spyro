/* func_level_31_80085664 (0x80085664, level_31_gnastys_world_gnorc_cove
 * overlay, 0xAE0 bytes).
 *
...
/* Homing-shot state block (types 0xCA / 0xCF). */
...
Actor *func_level_31_80085664(int type, Actor *parent) {
  Actor *rec;
  int owner;
