/* func_level_19_800866D8 (0x800866D8, level_19_beast_makers_terrace_village
 ...
 * This variant's classes: 0x0, 0x1, 0x2, 0x6, 0x7, 0x9, 0xA, 0xC, 0x15, 0x18, 0x21, 0x42, 0x46, 0x47, 0x4A, 0x4C, 0x4D, 0x4E, 0x4F, 0x50.
 *
 * Arm 0x7 is decoded here (the terrace-village drifting spark: an optional
 * arg3-scaled random offset on the spawn point, life = phase * 4, and a
 * three-axis (rand & 0xE) - 7 velocity).
...
void func_level_19_800866D8(int count, int type, int *pos, int arg3) {
  int v0[3];
  int v1[3];
  int v2[3];
  int v3[3];
