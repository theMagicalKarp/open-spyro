/* func_level_24_800897FC (0x800897FC, level_24_dream_weavers_home overlay,
 * 0x1228 bytes).
 *
 * The emit-list ADVANCE pass -- the Dream-Weavers-home 1162-insn variant.
 ...
 *
 * Arm-for-arm the level_18 set plus class 0x4A, the drifting mote -- the one
 * arm in the family that tests the alive byte BEFORE the age, which is why
 * its `rec[0x3] == 0` sits on the left of the `||`.  Same 21-arm register
 * pressure as level_18: `step * 2` spills to the frame and the phase-toggle
 * `1` is not hoisted.
 *
 * Verified byte-identical inside the relinked
 * level_24_dream_weavers_home.ovl.
 */
/* func_level_24_800897FC (0x80083274, level_2_artisans_dark_hollow overlay,
 * 0x122c bytes).
 *
...
void func_level_24_800897FC(int step) {
