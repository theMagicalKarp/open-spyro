/* func_level_11_80082300 (0x80082300, level_11_peace_keepers_night_flight
 * overlay, 0xc58 bytes).
 *
 * The emit-list ADVANCE pass -- the sibling of func_level_11_80082F58 (which
...
void func_level_11_80082300(int step) {
