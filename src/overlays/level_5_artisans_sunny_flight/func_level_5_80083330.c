/* func_level_5_80083330 (0x80083330, level_5_artisans_sunny_flight
 * overlay, 0xdf8 bytes).
 *
 * The emit-list ADVANCE pass -- the sibling of func_level_5_8008249C (which
...
void func_level_5_80083330(int step) {
