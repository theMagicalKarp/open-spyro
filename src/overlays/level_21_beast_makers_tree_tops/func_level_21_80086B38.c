/* func_level_21_80086B38 (0x80086B38, level_21_beast_makers_tree_tops
 * overlay, 0x8C8 bytes).
 *
 ...
 *  - 0x43..0x45 / 0xFF..0x101 / 0x135..0x137 / 0x1A7..0x1A9 (debris bursts):
...
/* Debris state block (types 0x43..0x45, 0xFF..0x101, 0x135..0x137, 0x1A7..9). */
...
Actor *func_level_21_80086B38(int type, Actor *parent) {
  Actor *rec;
  int owner;
