/* func_level_18_80089AB8 (0x80089AB8, level_18_beast_makers_home
 ...
 * This variant's classes: 0x0, 0x1, 0x2, 0x6, 0x9, 0xA, 0xC, 0x10, 0x11, 0x18, 0x21, 0x42, 0x46, 0x47, 0x4D, 0x4E, 0x4F, 0x50.
 *
...
void func_level_18_80089AB8(int count, int type, int *pos, int arg3) {
  int v0[3];
  int v1[3];
  int v2[3];
  int v3[3];
