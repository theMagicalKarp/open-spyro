...
|--:|---|---|---|--:|--:|---|
| 1 | `0x8003c358` | func_8003C358 | main | 908 | 107 | matched neighbor in segment; jal-chain shape (23 calls) |
| 2 | `0x8001ed5c` | GamestateDraw | main | 1020 | 105 | matched neighbor in segment; jal-chain shape (33 calls) |
| 3 | `0x8003385c` | GamestateUpdate | main | 1012 | 105 | matched neighbor in segment; jal-chain shape (26 calls) |
| 4 | `0x80038638` | func_80038638 | main | 740 | 101 | matched neighbor in segment |
| 5 | `0x8005df60` | ResetCallback | main | 220 | 101 | matched neighbor in segment; jal-chain shape (8 calls); previously attempted (2026-07-11: setjmp/held-base-heavy (libgpu bring-up cluster)) |
| 6 | `0x800127c0` | Initialize | main | 1328 | 99 | matched neighbor in segment; jal-chain shape (57 calls) |
| 7 | `0x80019300` | EnqueueLoadingScreenSprites | main | 920 | 97 | matched neighbor in segment |
| 8 | `0x8002bbe0` | TickCdMusicStream | main | 1024 | 95 | matched neighbor in segment |
| 9 | `0x8002bfe0` | AdvanceGemCutsceneFrame | main | 1088 | 94 | matched neighbor in segment |
| 10 | `0x8002cb6c` | EndGemPickupToWorld | main | 348 | 94 | — |
| 11 | `0x800499c0` | TickSpyroHornStrikeAttack | main | 1084 | 94 | matched neighbor in segment |
| 12 | `0x8005637c` | TickActiveSoundVoices | main | 1144 | 93 | matched neighbor in segment |
| 13 | `0x80012d58` | UnpackWorldDataChunks | main | 1240 | 91 | matched neighbor in segment |
| 14 | `0x8002da74` | AnimateGemTallyParticles | main | 1320 | 89 | matched neighbor in segment |
| 15 | `0x8003abc0` | func_8003ABC0 | main | 1308 | 89 | matched neighbor in segment |

(187 viable candidates total; the full ranking is regenerable.)
