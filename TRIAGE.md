...
| 6 | `0x80059594` | func_80059594 | main | 720 | 101 | matched neighbor in segment |
| 7 | `0x8005df60` | ResetCallback | main | 220 | 101 | matched neighbor in segment; jal-chain shape (8 calls); previously attempted (2026-07-11: setjmp/held-base-heavy (libgpu bring-up cluster)) |
| 8 | `0x800127c0` | Initialize | main | 1328 | 99 | matched neighbor in segment; jal-chain shape (57 calls) |
| 9 | `0x80019300` | EnqueueLoadingScreenSprites | main | 920 | 97 | matched neighbor in segment |
| 10 | `0x8002bbe0` | TickCdMusicStream | main | 1024 | 95 | matched neighbor in segment |
| 11 | `0x8003a420` | func_8003A420 | main | 768 | 95 | jal-chain shape (20 calls) |
| 12 | `0x8002bfe0` | AdvanceGemCutsceneFrame | main | 1088 | 94 | matched neighbor in segment |
| 13 | `0x8002cb6c` | EndGemPickupToWorld | main | 348 | 94 | — |
| 14 | `0x800499c0` | TickSpyroHornStrikeAttack | main | 1084 | 94 | matched neighbor in segment |
| 15 | `0x8005637c` | TickActiveSoundVoices | main | 1144 | 93 | matched neighbor in segment |

(194 viable candidates total; the full ranking is regenerable.)
