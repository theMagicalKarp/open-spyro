...
**26 vein-ready overlay candidates** (overlay segment + a clone signal). The session prompt runs clone/vein while this is >= 3; harvest is the fallback below that, not the default — overlay clone families have historically paid 5-20x a park sweep.

Segments in play: ovl/level_10_peace_keepers_doctor_shemp, ovl/level_11_peace_keepers_night_flight, ovl/level_12_magic_crafters_home, ovl/level_17_magic_crafters_crystal_flight, ovl/level_18_beast_makers_home, ovl/level_1_artisans_stone_hill, ovl/level_23_beast_makers_wild_flight, ovl/level_24_dream_weavers_home, ovl/level_28_dream_weavers_jacques, ovl/level_29_dream_weavers_icy_flight, ovl/level_2_artisans_dark_hollow, ovl/level_30_gnastys_world_gnorc_gnexus, ovl/level_3_artisans_town_square, ovl/level_4_artisans_toasty, ovl/level_6_peace_keepers_home, ovl/level_7_peace_keepers_dry_canyon, ovl/level_8_peace_keepers_cliff_town

## Top 60 candidates (vein / clone modes)

| # | Address | Function | Segment | Size | Score | Why |
|--:|---|---|---|--:|--:|---|
| 1 | `0x8008611c` | func_level_10_8008611C | ovl/level_10_peace_keepers_doctor_shemp | 4340 | 153 | overlay (no -g3); segment 4.6% matched; clone family of 5 (one recipe pays 5×); matched neighbor in segment; jal-chain shape (115 calls); megafunction (all-or-nothing) |
| 2 | `0x8008391c` | func_level_4_8008391C | ovl/level_4_artisans_toasty | 4340 | 152 | overlay (no -g3); segment 6.0% matched; clone family of 5 (one recipe pays 5×); matched neighbor in segment; jal-chain shape (115 calls); megafunction (all-or-nothing) |
| 3 | `0x800844a0` | func_level_2_800844A0 | ovl/level_2_artisans_dark_hollow | 4340 | 152 | overlay (no -g3); segment 5.4% matched; clone family of 5 (one recipe pays 5×); matched neighbor in segment; jal-chain shape (115 calls); megafunction (all-or-nothing) |
| 4 | `0x80085254` | func_level_28_80085254 | ovl/level_28_dream_weavers_jacques | 4340 | 152 | overlay (no -g3); segment 5.3% matched; clone family of 5 (one recipe pays 5×); matched neighbor in segment; jal-chain shape (115 calls); megafunction (all-or-nothing) |
| 5 | `0x8007b0d0` | func_level_1_8007B0D0 | ovl/level_1_artisans_stone_hill | 8096 | 143 | overlay (no -g3); segment 4.5% matched; clone family of 10 (one recipe pays 10×); matched neighbor in segment; megafunction (all-or-nothing) |
| 6 | `0x8007d070` | func_level_1_8007D070 | ovl/level_1_artisans_stone_hill | 2568 | 143 | overlay (no -g3); segment 4.5% matched; clone family of 10 (one recipe pays 10×); megafunction (all-or-nothing) |
| 7 | `0x8007b0ac` | func_level_3_8007B0AC | ovl/level_3_artisans_town_square | 8096 | 142 | overlay (no -g3); segment 5.4% matched; clone family of 10 (one recipe pays 10×); matched neighbor in segment; megafunction (all-or-nothing) |
| 8 | `0x8007b898` | func_level_7_8007B898 | ovl/level_7_peace_keepers_dry_canyon | 8096 | 142 | overlay (no -g3); segment 5.0% matched; clone family of 10 (one recipe pays 10×); matched neighbor in segment; megafunction (all-or-nothing) |
| 9 | `0x8007b898` | func_level_8_8007B898 | ovl/level_8_peace_keepers_cliff_town | 8096 | 142 | overlay (no -g3); segment 5.0% matched; clone family of 10 (one recipe pays 10×); matched neighbor in segment; megafunction (all-or-nothing) |
| 10 | `0x8007d04c` | func_level_3_8007D04C | ovl/level_3_artisans_town_square | 2568 | 142 | overlay (no -g3); segment 5.4% matched; clone family of 10 (one recipe pays 10×); megafunction (all-or-nothing) |
| 11 | `0x8007d838` | func_level_7_8007D838 | ovl/level_7_peace_keepers_dry_canyon | 2568 | 142 | overlay (no -g3); segment 5.0% matched; clone family of 10 (one recipe pays 10×); megafunction (all-or-nothing) |
| 12 | `0x8007d838` | func_level_8_8007D838 | ovl/level_8_peace_keepers_cliff_town | 2568 | 142 | overlay (no -g3); segment 5.0% matched; clone family of 10 (one recipe pays 10×); megafunction (all-or-nothing) |
| 13 | `0x8007b7e4` | func_level_18_8007B7E4 | ovl/level_18_beast_makers_home | 8096 | 139 | overlay (no -g3); segment 12.0% matched; clone family of 10 (one recipe pays 10×); matched neighbor in segment; megafunction (all-or-nothing) |
| 14 | `0x8007b9f0` | func_level_12_8007B9F0 | ovl/level_12_magic_crafters_home | 8096 | 139 | overlay (no -g3); segment 11.1% matched; clone family of 10 (one recipe pays 10×); matched neighbor in segment; megafunction (all-or-nothing) |
| 15 | `0x8007b9f8` | func_level_6_8007B9F8 | ovl/level_6_peace_keepers_home | 8096 | 139 | overlay (no -g3); segment 11.1% matched; clone family of 10 (one recipe pays 10×); matched neighbor in segment; megafunction (all-or-nothing) |
| 16 | `0x8007ba18` | func_level_24_8007BA18 | ovl/level_24_dream_weavers_home | 8096 | 139 | overlay (no -g3); segment 11.4% matched; clone family of 10 (one recipe pays 10×); matched neighbor in segment; megafunction (all-or-nothing) |
| 17 | `0x8007d784` | func_level_18_8007D784 | ovl/level_18_beast_makers_home | 2568 | 139 | overlay (no -g3); segment 12.0% matched; clone family of 10 (one recipe pays 10×); megafunction (all-or-nothing) |
| 18 | `0x8007d990` | func_level_12_8007D990 | ovl/level_12_magic_crafters_home | 2568 | 139 | overlay (no -g3); segment 11.1% matched; clone family of 10 (one recipe pays 10×); megafunction (all-or-nothing) |
| 19 | `0x8007d998` | func_level_6_8007D998 | ovl/level_6_peace_keepers_home | 2568 | 139 | overlay (no -g3); segment 11.1% matched; clone family of 10 (one recipe pays 10×); megafunction (all-or-nothing) |
| 20 | `0x8007d9b8` | func_level_24_8007D9B8 | ovl/level_24_dream_weavers_home | 2568 | 139 | overlay (no -g3); segment 11.4% matched; clone family of 10 (one recipe pays 10×); megafunction (all-or-nothing) |
| 21 | `0x8007af90` | func_level_30_8007AF90 | ovl/level_30_gnastys_world_gnorc_gnexus | 8096 | 137 | overlay (no -g3); segment 15.3% matched; clone family of 10 (one recipe pays 10×); matched neighbor in segment; megafunction (all-or-nothing) |
| 22 | `0x8007cf30` | func_level_30_8007CF30 | ovl/level_30_gnastys_world_gnorc_gnexus | 2568 | 137 | overlay (no -g3); segment 15.3% matched; clone family of 10 (one recipe pays 10×); megafunction (all-or-nothing) |
| 23 | `0x8005df60` | ResetCallback | main | 220 | 133 | segment 35.6% matched; matched neighbor in segment; jal-chain shape (8 calls); previously attempted (2026-07-11: setjmp/held-base-heavy (libgpu bring-up cluster)) |
| 24 | `0x8005dbb4` | ExitCriticalSection | main | 16 | 122 | segment 35.6% matched; matched neighbor in segment; asm-hint (GTE/handwritten fragments) |
| 25 | `0x8003abc0` | func_8003ABC0 | main | 1308 | 121 | segment 35.6% matched; matched neighbor in segment |
| 26 | `0x800324d8` | Gamestate0C_Update | main | 1352 | 120 | segment 35.6% matched; matched neighbor in segment |
| 27 | `0x8007b68c` | func_level_23_8007B68C | ovl/level_23_beast_makers_wild_flight | 6440 | 120 | overlay (no -g3); segment 20.5% matched; clone family of 5 (one recipe pays 5×); megafunction (all-or-nothing) |
| 28 | `0x800557cc` | func_800557CC | main | 400 | 119 | segment 35.6% matched; matched neighbor in segment; previously attempted (2026-07-12: B13 lh+sra expected; multi-idiom, no ghidra seed) |
| 29 | `0x8005b8e0` | start | main | 168 | 119 | segment 35.6% matched; matched neighbor in segment; asm-hint (GTE/handwritten fragments) |
| 30 | `0x8007b68c` | func_level_11_8007B68C | ovl/level_11_peace_keepers_night_flight | 6440 | 119 | overlay (no -g3); segment 22.3% matched; clone family of 5 (one recipe pays 5×); megafunction (all-or-nothing) |
| 31 | `0x8007b68c` | func_level_17_8007B68C | ovl/level_17_magic_crafters_crystal_flight | 6440 | 119 | overlay (no -g3); segment 21.1% matched; clone family of 5 (one recipe pays 5×); megafunction (all-or-nothing) |
| 32 | `0x8007b68c` | func_level_29_8007B68C | ovl/level_29_dream_weavers_icy_flight | 6440 | 115 | overlay (no -g3); segment 30.8% matched; clone family of 5 (one recipe pays 5×); megafunction (all-or-nothing) |
| 33 | `0x80016914` | FillWord | main | 28 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 34 | `0x80016930` | FillBlock16 | main | 40 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 35 | `0x80016d08` | CountLeadingZeros | main | 36 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 36 | `0x80017908` | AbsAngleDelta8 | main | 32 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 37 | `0x80017928` | AbsAngleDelta12 | main | 32 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 38 | `0x80017948` | SignedAngleDelta8 | main | 36 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 39 | `0x8001796c` | SignedAngleDelta12 | main | 36 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 40 | `0x8005dba4` | EnterCriticalSection | main | 16 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 41 | `0x800625f8` | SetTransMatrix | main | 32 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 42 | `0x80062618` | SetGeomOffset | main | 24 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 43 | `0x80062638` | SetGeomScreen | main | 12 | 107 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 44 | `0x80016958` | CopyWords | main | 84 | 106 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 45 | `0x800177c0` | ScaleVector3Sat | main | 56 | 106 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 46 | `0x80017e54` | ComputeDepthCuedColor | main | 68 | 106 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 47 | `0x8004bdec` | func_8004BDEC | main | 96 | 106 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 48 | `0x80062350` | InitGeom | main | 128 | 105 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 49 | `0x800524c4` | AllocActorRecordSlot | main | 164 | 104 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 50 | `0x8004fdac` | BlendDepthCuedEdgeColor | main | 244 | 103 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 51 | `0x8004fea0` | EmitDynamicActorMeshFogged | main | 240 | 103 | segment 35.6% matched; asm-hint (GTE/handwritten fragments) |
| 52 | `0x80085f40` | func_level_16_80085F40 | ovl/level_16_magic_crafters_blowhard | 5468 | 75 | overlay (no -g3); segment 0.0% matched; matched neighbor in segment; jal-chain shape (154 calls); megafunction (all-or-nothing) |
| 53 | `0x800861cc` | func_level_20_800861CC | ovl/level_20_beast_makers_misty_bog | 3940 | 75 | overlay (no -g3); segment 4.9% matched; matched neighbor in segment; jal-chain shape (108 calls); megafunction (all-or-nothing) |
| 54 | `0x80086d38` | func_level_25_80086D38 | ovl/level_25_dream_weavers_dark_passage | 5020 | 75 | overlay (no -g3); segment 0.0% matched; matched neighbor in segment; jal-chain shape (138 calls); megafunction (all-or-nothing) |
| 55 | `0x8008869c` | func_level_21_8008869C | ovl/level_21_beast_makers_tree_tops | 4524 | 73 | overlay (no -g3); segment 3.9% matched; matched neighbor in segment; jal-chain shape (119 calls); megafunction (all-or-nothing) |
| 56 | `0x8008b0b0` | func_level_14_8008B0B0 | ovl/level_14_magic_crafters_high_caves | 5772 | 73 | overlay (no -g3); segment 4.4% matched; matched neighbor in segment; jal-chain shape (169 calls); megafunction (all-or-nothing) |
| 57 | `0x8008c9d8` | func_level_13_8008C9D8 | ovl/level_13_magic_crafters_alpine_ridge | 5352 | 73 | overlay (no -g3); segment 4.1% matched; matched neighbor in segment; jal-chain shape (155 calls); megafunction (all-or-nothing) |
| 58 | `0x80084eac` | func_level_32_80084EAC | ovl/level_32_gnastys_world_twilight_harbor | 4440 | 72 | overlay (no -g3); segment 5.8% matched; matched neighbor in segment; jal-chain shape (119 calls); megafunction (all-or-nothing) |
| 59 | `0x80085184` | func_level_9_80085184 | ovl/level_9_peace_keepers_ice_cavern | 4316 | 72 | overlay (no -g3); segment 5.3% matched; matched neighbor in segment; jal-chain shape (122 calls); megafunction (all-or-nothing) |
| 60 | `0x80086438` | func_level_26_80086438 | ovl/level_26_dream_weavers_lofty_castle | 4836 | 72 | overlay (no -g3); segment 5.4% matched; matched neighbor in segment; jal-chain shape (130 calls); megafunction (all-or-nothing) |

(97 viable candidates total; the full ranking is regenerable.)
...
| `0x8007b68c` | func_level_5_8007B68C | ovl/level_5_artisans_sunny_flight | 6440 | 1060 | B14 RETIRED -> now length-exact (1610/1610), MISMATCH 78 content-aligned |
| `0x800499c0` | TickSpyroHornStrikeAttack | main | 1084 | 944 |  |
| `0x80083ab4` | func_level_16_80083AB4 | ovl/level_16_magic_crafters_blowhard | 3452 | 908 |  |
...
| `0x8007b020` | func_level_0_8007B020 | ovl/level_0_artisans_home | 8096 | 676 | R1 cross-jump asymmetry (7 insns) + 4 addressing/sched ties; 2009/2024, 87 mismatched |
...
| `0x80038c4c` | func_80038C4C | main | 264 | 240 | F1 local-alloc ORDER, 6/66 (unchanged; 2026-08-11: the fresh-local-for-abs split is byte-identical, so the rx quantity does not reach the ay v1-vs-a1 tie) |
