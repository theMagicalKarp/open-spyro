...
| 12 | `0x8005df60` | ResetCallback | main | 220 | 132 | segment 37.6% matched; matched neighbor in segment; jal-chain shape (8 calls); previously attempted (2026-07-11: setjmp/held-base-heavy (libgpu bring-up cluster)) |
...
| `0x8007b68c` | func_level_5_8007B68C | ovl/level_5_artisans_sunny_flight | 6440 | 5884 | R1 sched1 straggler-hole (21) + A127 frame slot count (16) + three small ties (14) |
...
| `0x8001ca38` | RespawnOrGameOver_Draw | main | 1444 | 1368 |  |
...
| `0x8003d6d0` | TurnSpyroTowardMoveTargetWithLean | main | 368 | 360 | F1 local-alloc qty_compare tie needing exactly R=3 on the first-loaded temp |
...
| `0x8005f2a4` | ResetGraph | main | 388 | 0 |  |
