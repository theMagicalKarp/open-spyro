...
**4 vein-ready overlay candidates** (overlay segment + a clone signal). The session prompt runs clone/vein while this is >= 3; harvest is the fallback below that, not the default — overlay clone families have historically paid 5-20x a park sweep.

Segments in play: ovl/level_11_peace_keepers_night_flight, ovl/level_17_magic_crafters_crystal_flight, ovl/level_23_beast_makers_wild_flight, ovl/level_29_dream_weavers_icy_flight
