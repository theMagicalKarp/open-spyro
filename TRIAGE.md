...
**22 vein-ready overlay candidates** (overlay segment + a clone signal). The session prompt runs clone/vein while this is >= 3; harvest is the fallback below that, not the default — overlay clone families have historically paid 5-20x a park sweep.
...
| `0x8007cfc0` | func_level_0_8007CFC0 | ovl/level_0_artisans_home | 2568 | 368 | decode-incomplete (NOT the claimed allocation shift) |
